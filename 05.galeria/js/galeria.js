/*===========================================================
OBJETOS CON LAS PROPIEDADES DE LA GALERIA
=============================================================*/
...
/*===========================================================
OBJETOS CON LAS METODOS DE LA GALERIA
=============================================================*/
...
var mg = {
  ...
  lightbox: function(img) {
    pg.cuerpoDom.appendChild(document.createElement("DIV")).setAttribute(
      "id", "lightbox");
    ...
    pg.lightbox.appendChild(document.createElement("DIV")).setAttribute(
      "id", "modal");
    ...
    if (pg.animacionGaleria == "slide") {
      ...
      setTimeout(function() {
        ...
        pg.modal.style.marginLeft = -pg.modal.childNodes[0].width / 2 +
          "px";
        pg.modal.style.marginTop = -pg.modal.childNodes[0].height / 2 +
          "px";
